...
export class Transform {
    ...
    equalsApprox(transform: Transform, epsilon = 1e-6): boolean {
    ...
    equalsTRS(position: Vec3, rotation: Quat, scale: Vec3): boolean {
        return this.position.equals(position) &&
            this.rotation.equals(rotation) &&
            this.scale.equals(scale);
    }

    equalsApproxTRS(position: Vec3, rotation: Quat, scale: Vec3, epsilon = 1e-6): boolean {
