...
const TEMPLATES = {
    ...
    1001: { // Exterior / Interior
        ...
        entities: {
            ...
            'ground': { name: 'Ground Plane', components: { model: { type: 'plane' } } },
        },
        settings: { sky: { type: 'skybox', intensity: 0.8 }, render: { toneMapping: 'ACES', exposure: 1.0, global_ambient: [0.4, 0.45, 0.5] } },
    },
    1002: { // Animation / Walkthrough
        ...
        entities: {
            ...
            'ground': { name: 'Ground', components: { model: { type: 'plane' } } },
        },
    ...
    2001: { // XR / AR
        ...
        entities: {
            ...
            'floor': { name: 'Floor Plane', components: { model: { type: 'plane' } } },
        },
        settings: { xr: { enabled: true, type: 'auto', imageTracking: true, hitTest: true, anchors: true }, render: { global_ambient: [0.4, 0.4, 0.4] } },
    },
    2002: { // VR
        name: 'VR Scene',
        entities: {
            ...
            'floor': { name: 'VR Floor', components: { model: { type: 'plane' } } },
        ...
        settings: { xr: { enabled: true, type: 'vr', teleportation: true, handTracking: true, controllerModel: true }, render: { global_ambient: [0.3, 0.3, 0.4] } },
    },
    2003: { // Virtual Tour
        name: 'Tour Scene',
        entities: {
        ...
        settings: { tour: { hotspots: true, infoPanels: true, floorPlan: true, transitions: 'fade' }, render: { global_ambient: [0.5, 0.5, 0.5] } },
    },
    2004: { // Gaussian Splat
        name: 'Splat Scene',
        entities: {
    ...
    2005: { // Pixel Streaming
        ...
        settings: { streaming: { enabled: true, encoder: 'h264', bitrate: 10000, framerate: 60, resolution: [1920, 1080] }, render: { global_ambient: [0.4, 0.4, 0.5] } },
    },
};
